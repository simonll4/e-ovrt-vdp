...
|---|---|---|
| Banco de imágenes `bench_v3` (6.477 imágenes, 3 fuentes) | [`bench_v3.json`](https://github.com/Pandulc/e-ovrt_datasets/blob/feature/datasets-v2-setup/datasets/processed/coco/bench/curated/bench_v3.json) | `4557024ecc4ee497ab1fad01d6819206395c10fd794010ed8c1d9198b19a4462` |
| Manifiesto del banco temporal (47 clips) | [`manifest.yaml`](https://github.com/Pandulc/e-ovrt_datasets/blob/feature/datasets-v2-setup/datasets/processed/clip_bench/manifest.yaml) | `3f14f50a53c0d6c57b429378544dcfb6ed87fc942640db302c53ba1470001a75` |

Las huellas de los estratos del banco de imágenes viajan dentro de su
[manifiesto de composición](https://github.com/Pandulc/e-ovrt_datasets/blob/feature/datasets-v2-setup/datasets/processed/coco/bench/curated/bench_v3_manifest.json)
(`source_sha256` por fuente); las del banco temporal, en
[`clip_bench.sha256`](https://github.com/Pandulc/e-ovrt_datasets/blob/feature/datasets-v2-setup/datasets/processed/clip_bench/clip_bench.sha256).
...
|---|---|---|---|
| Banco de imágenes | `bench_v3.json` (COCO), su manifiesto de composición y la ficha de procedencia por fuente | [`e-ovrt_datasets` · `datasets/processed/coco/bench/curated/`](https://github.com/Pandulc/e-ovrt_datasets/tree/feature/datasets-v2-setup/datasets/processed/coco/bench/curated) · [ficha `bench_v3`](https://github.com/Pandulc/e-ovrt_datasets/blob/feature/datasets-v2-setup/datasets/registry/bench_v3.md) | Huella de la tabla anterior; el generador del banco reproduce los estratos byte a byte ([`build_bench_v3.py`](https://github.com/Pandulc/e-ovrt_datasets/blob/feature/datasets-v2-setup/datasets/scripts/curate/build_bench_v3.py)) |
...
| Banco temporal | `manifest.yaml`, la referencia temporal humana por clip (`gt/`) y las anotaciones exportadas (`annotations/`) | [`e-ovrt_datasets` · `datasets/processed/clip_bench/`](https://github.com/Pandulc/e-ovrt_datasets/tree/feature/datasets-v2-setup/datasets/processed/clip_bench) | Huella de la tabla anterior; los videos no se publican (ver §4) |
| Configuración efectiva de un experimento | Manifiesto de la corrida: fuente, perfil del modelo, vocabulario, conjunto de patrones, instrumentación | [`e-ovrt_experimental-setup` · `experiments/`](https://github.com/simonll4/e-ovrt_experimental-setup/tree/HEAD/experiments) · patrones en [`e-ovrt_control-plane` · `configs/patterns/`](https://github.com/Pandulc/e-ovrt_control-plane/tree/feature/control-service/configs/patterns) | Parámetros solicitados contra parámetros aplicados, que la corrida conserva |
...
| Procedencia y licencias de los datos | Registro de licencias y de descargas por fuente | [`e-ovrt_datasets` · `datasets/registry/`](https://github.com/Pandulc/e-ovrt_datasets/tree/feature/datasets-v2-setup/datasets/registry) | Lo que el Anexo F declara por fuente |
